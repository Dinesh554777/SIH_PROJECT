import { BookText, Bot, Briefcase, Languages, Mic, FileText, Award, Zap, Rocket, File, Video, BookOpen, MessageSquare, Star } from 'lucide-react';
import type { Feature, TeamMember, CareerPath, Testimonial, TimelineEvent, Achievement, Resource, CommunityPost, TopLearner, Event, FeedbackItem, SavedNote, TimeSpentData, ToolUsageData } from './types';
...
export const TEAM_MEMBERS: TeamMember[] = [
    { name: 'Rohan Verma', role: 'Project Lead & Backend Developer', imageUrl: 'https://picsum.photos/seed/rohan/400/400', linkedin: 'https://linkedin.com' },
    { name: 'Priya Sharma', role: 'Frontend Developer & UI/UX Designer', imageUrl: 'https://picsum.photos/seed/priya/400/400', linkedin: 'https://linkedin.com' },
    { name: 'Ankit Gupta', role: 'AI & Machine Learning Engineer', imageUrl: 'https://picsum.photos/seed/ankit/400/400', linkedin: 'https://linkedin.com' },
    { name: 'Sneha Reddy', role: 'Database & Cloud Architect', imageUrl: 'https://picsum.photos/seed/sneha/400/400', linkedin: 'https://linkedin.com' },
];
...
export const RESOURCES_DATA: Resource[] = [
    { id: 1, title: 'Introduction to Neural Networks', description: 'A comprehensive PDF explaining the basics of neural networks.', category: 'AI', fileType: 'PDF', icon: File },
    { id: 2, title: 'Digital Logic Design Lecture', description: 'A recorded video lecture on DLD concepts.', category: 'Electronics', fileType: 'Video', icon: Video },
    { id: 3, title: 'Data Structures in Python', description: 'Class notes covering all major data structures.', category: 'CSE', fileType: 'Notes', icon: BookOpen },
    { id: 4, title: 'Thermodynamics Basics', description: 'An introductory guide to thermodynamics for mechanical engineers.', category: 'Mechanical', fileType: 'PDF', icon: File },
    { id: 5, title: 'Advanced Algorithms', description: 'In-depth notes on complex algorithms and their analysis.', category: 'CSE', fileType: 'Notes', icon: BookOpen },
    { id: 6, title: 'Machine Learning with Scikit-Learn', description: 'Video tutorial series on practical machine learning.', category: 'AI', fileType: 'Video', icon: Video },
];
